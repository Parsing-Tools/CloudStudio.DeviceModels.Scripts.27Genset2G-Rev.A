...
# Parsing Script – 27 Genset 2G - Rev. A

This **Parsing** script is designed for the **27 Genset 2G** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – 27 Genset 2G Rev. A

Este script de **Parsing** está diseñado para el modelo **27 Genset 2G** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
